// Centro de Aprendizaje — cada concepto debe alcanzar para que alguien sin
// formación contable entienda, de una sola lectura, qué es, cómo se
// calcula y por qué le importa. "categoria" agrupa los conceptos en
// capítulos (como un libro), en vez de una lista plana de 20+ ítems.

export const CATEGORIAS_APRENDE = [
...
export const CONCEPTOS_APRENDE = [
  {
    emoji: "💰", titulo: "Ingresos", categoria: "Lo básico del dinero",
  ...
  {
    emoji: "🛒", titulo: "Gastos", categoria: "Lo básico del dinero",
  ...
  {
    emoji: "🏠", titulo: "Costos Fijos", categoria: "Lo básico del dinero",
    ...
    consejo: "Calcula cuánto necesitas vender SOLO para cubrir tus costos fijos — ese es tu Punto de Equilibrio (más abajo en esta misma sección). Marca cada costo como pagado solo cuando realmente hiciste el pago, así tu flujo de caja siempre refleja la realidad.",
  ...
  {
    emoji: "📊", titulo: "Utilidad Neta", categoria: "Lo básico del dinero",
  ...
  {
    emoji: "⚡", titulo: "Flujo de Caja", categoria: "Lo básico del dinero",
  ...
  {
    emoji: "💵", titulo: "Disponible", categoria: "Lo básico del dinero",
  ...
  {
    emoji: "👝", titulo: "Retiro", categoria: "Lo básico del dinero",
  ...
  {
    emoji: "➕", titulo: "Ingreso Extra", categoria: "Lo básico del dinero",
  ...
  {
    emoji: "📈", titulo: "Margen de Ganancia", categoria: "Rentabilidad y precios",
  ...
  {
    emoji: "⭐", titulo: "Ticket Promedio", categoria: "Rentabilidad y precios",
  ...
  {
    emoji: "🎯", titulo: "Punto de Equilibrio", categoria: "Rentabilidad y precios",
    def: "El monto mínimo que necesitas vender en un período para que tus ingresos cubran exactamente tus costos — ni ganas ni pierdes. Vender por encima de ese número es cuando empieza tu utilidad real.",
    calculo: "Punto de equilibrio = Costos Fijos del período ÷ Margen de Ganancia (en decimal, no en %). Ejemplo: un margen de 40% se usa como 0,4 en la fórmula.",
    ejemplo: "Tus costos fijos son $400.000 al mes y tu margen promedio es 40% → Punto de equilibrio = $400.000 ÷ 0,4 = $1.000.000. Necesitas vender $1.000.000 en el mes solo para no perder ni ganar.",
    cuando: "Recalcúlalo cada vez que cambien tus costos fijos (por ejemplo, si sube el arriendo) o tu margen promedio.",
    consejo: "Si vendes por debajo de tu punto de equilibrio de forma seguida, el negocio está perdiendo dinero aunque las ventas se vean bien en la caja diaria.",
    error: "Pensar que vender algo siempre es mejor que no vender nada. El punto de equilibrio YA incluye cubrir tus costos fijos — vender menos que eso sigue siendo pérdida, no solo 'menos ganancia'.",
    impacto: "Te dice el mínimo real que necesitas vender para sobrevivir. Todo lo que vendas por encima de ese número es lo que realmente te queda como ganancia."
  },
  {
    emoji: "⚖️", titulo: "Costo Promedio Ponderado", categoria: "Rentabilidad y precios",
  ...
  {
    emoji: "📦", titulo: "Inventario", categoria: "Inventario y ventas",
  ...
  {
    emoji: "📷", titulo: "Código de Barras", categoria: "Inventario y ventas",
  ...
  {
    emoji: "🥩", titulo: "Venta por Peso", categoria: "Inventario y ventas",
  ...
  {
    emoji: "📆", titulo: "Lotes y Fecha de Vencimiento", categoria: "Inventario y ventas",
    def: "Cuando repones inventario de un producto que vence (como alimentos), cada reposición queda guardada como un 'lote' separado, con su propia fecha de vencimiento — así NELYX sabe exactamente qué stock vence primero, aunque tengas el mismo producto comprado en fechas distintas. El registro completo de todos los lotes de un producto se llama su Kardex.",
    calculo: "No es un cálculo — es un registro por reposición. Cada vez que repones stock con una fecha de vencimiento distinta, se crea un lote nuevo. Al vender, NELYX descuenta primero del lote más antiguo (esto se llama FIFO: 'primero en entrar, primero en salir'), para que el stock más próximo a vencer se venda antes que el más nuevo.",
    ejemplo: "Repones 20 yogures que vencen el 5 de octubre, y una semana después repones 15 más que vencen el 15 de octubre → son 2 lotes distintos. Cuando vendes, se descuentan primero los que vencen el 5 de octubre.",
    cuando: "Se crea automáticamente cada vez que repones stock indicando una fecha de vencimiento, en Productos o en 'Actualizar inventario'.",
    consejo: "Revisa la sección 'Productos por vencer' en Alertas regularmente — te muestra los lotes más próximos a vencer para que puedas hacer una promoción antes de perder ese stock.",
    error: "Pensar que el vencimiento es del producto en general — en realidad es de cada lote. Un mismo producto puede tener stock con distintas fechas de vencimiento al mismo tiempo.",
    impacto: "Evita pérdidas por productos vencidos y te permite reaccionar a tiempo con descuentos antes de que ese stock se eche a perder — especialmente importante si vendes alimentos u otros productos perecibles."
  },
  {
    emoji: "📋", titulo: "Cuentas por Cobrar", categoria: "Clientes y cobranza",
  ...
  {
    emoji: "💬", titulo: "Centro de Cobranza", categoria: "Clientes y cobranza",
  ...
  {
    emoji: "🏷️", titulo: "Segmentación de Clientes", categoria: "Clientes y cobranza",
    def: "Una etiqueta automática que NELYX le pone a cada cliente según su historial real de compras — sin que tú tengas que clasificarlos a mano. Te ayuda a saber a quién cuidar, a quién contactar y a quién ya no esperar.",
    calculo: "NELYX mira 3 cosas por cliente: hace cuánto no compra, cada cuánto compra normalmente, y cuánto ha gastado en total comparado con el resto de tu cartera. Con eso arma 6 categorías: Nuevo 🆕 (1 compra o menos), Valioso 💎 (está entre el 15% que más ha gastado en tu negocio), Frecuente 🔥 (compra seguido y mantiene su ritmo habitual), En riesgo ⏰ (ya debería haber vuelto a comprar según su propio patrón y no lo ha hecho), Inactivo 💤 (cliente marcado como inactivo) y Regular 👤 (el resto).",
    ejemplo: "Ana compra cada 10 días en promedio. Ya pasaron 18 días desde su última compra (18 es más de 10 × 1,5) → NELYX la marca 'En riesgo ⏰' y te avisa: 'Debería haber vuelto: suele comprar cada ~10 días y van 18 sin novedad.'",
    cuando: "Se recalcula solo, cada vez que entras al módulo Clientes — no requiere que hagas nada.",
    consejo: "Revisa primero a los clientes 'En riesgo' — son los que tienen más probabilidad de perderse si no los contactas pronto. Los 'Valiosos' merecen atención especial porque representan una parte grande de tus ingresos.",
    error: "Pensar que el segmento es fijo — un cliente puede pasar de 'En riesgo' a 'Frecuente' apenas vuelve a comprar, y de 'Frecuente' a 'En riesgo' si deja de venir.",
    impacto: "Te permite enfocar tu tiempo y tus promociones en quien realmente importa, sin tener que revisar el historial de cada cliente uno por uno."
  },
  {
    emoji: "🛡️", titulo: "Límite de Crédito Sugerido", categoria: "Clientes y cobranza",
    def: "Un monto máximo recomendado que NELYX calcula para cada cliente, basado en su propio historial de compras — te ayuda a decidir hasta cuánto fiarle sin arriesgar demasiado.",
    calculo: "Límite sugerido = Ticket promedio del cliente × 3, redondeado a un número fácil de leer (mínimo $10.000). Solo se sugiere si el cliente ya tiene 2 o más compras registradas — sin historial, no hay base para sugerir nada.",
    ejemplo: "Un cliente que en promedio compra $25.000 por vez → Límite sugerido = $25.000 × 3 = $75.000 → redondeado, $80.000.",
    cuando: "Aparece como sugerencia al editar el límite de crédito de un cliente en el módulo Clientes.",
    consejo: "Es solo un punto de partida — tú conoces a tus clientes mejor que cualquier cálculo. Ajústalo a mano si confías más o menos en alguien en particular. Una vez definido, NELYX te avisa si una venta a crédito superaría ese límite.",
    error: "Fijar el mismo límite de crédito para todos los clientes sin importar su historial — un cliente nuevo y uno de años de confianza no deberían tener el mismo límite.",
    impacto: "Reduce el riesgo de acumular cuentas por cobrar impagables, sin tener que decir que no a la venta a crédito por completo."
  },
  {
    emoji: "💳", titulo: "Deudas", categoria: "Deudas y liquidez",
  ...
  {
    emoji: "🕐", titulo: "Liquidez Proyectada", categoria: "Deudas y liquidez",
